...
export const audienceConfig = {
  phys: {
    ...
    description: `Оказываем юридическую помощь гражданам и представляем интересы доверителей в судах всех инстанций и государственных органах. Мы — команда профессионалов с большим практическим опытом ведения дел различной сложности и формированием правовой позиции на основе документов и судебной практики.
Берём на себя подготовку процессуальных документов и сопровождение дела на всех этапах — от первичной консультации и досудебного урегулирования до исполнения судебного решения. Работаем строго по договору, соблюдаем конфиденциальность и адвокатскую тайну, даём понятный план действий и контролируем сроки на каждом этапе.`
  },
  biz: {
