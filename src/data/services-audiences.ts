...
Чем раньше Вы обратитесь ко нам, тем больше шансов на положительный исход вашего дела. Без пафоса, мы профессионалы в уголовном праве и обязательно Вам поможем.`
  }
};
