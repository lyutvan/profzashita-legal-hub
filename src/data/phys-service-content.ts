...
const CATEGORY_MARKETING_SUBTITLES: Record<string, string> = {
  "Ущерб имуществу": "Помогаем взыскать ущерб и вернуть стоимость поврежденного имущества. Берем на себя переговоры, документы и суд.",
  "Наследственные дела": "Сопровождаем наследственные споры и оформление наследства: от консультации до суда и регистрации прав.",
  "Взыскание долгов и договорные споры": "Возвращаем долги и защищаем интересы по договорам — от претензии до исполнения решения.",
  "Защита прав потребителей": "Защищаем потребителей и добиваемся выплат: составим требования, переговорим и отстоим позицию в суде.",
  "ДТП, страхование, вред здоровью": "Добиваемся страховых выплат и компенсаций после ДТП и вреда здоровью. Работаем по договору.",
  "Трудовые споры": "Защищаем права работников и работодателей: увольнения, выплаты, дисциплинарные споры.",
  "Банковские и кредитные споры": "Снижаем долговую нагрузку, оспариваем требования банков и сопровождаем споры по кредитам.",
...
const getCategoryContent = (category: string): PhysCategoryContent => {
  ...
  return {
    heroSubtitle:
      CATEGORY_MARKETING_SUBTITLES[category] ??
