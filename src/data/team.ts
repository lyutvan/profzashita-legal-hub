...
export const teamMembers: TeamMember[] = [
  {
    ...
    about: "Имеет 18 лет службы в органах предварительного следствия и глубокое понимание логики расследований. Начальник следственного отдела ГСУ в отставке, подполковник юстиции. Практический опыт следствия позволяет выстраивать защиту с учётом процессуальных нюансов и реальных сценариев работы следственных органов.\n\nСопровождает уголовные дела на стадиях проверки, следствия и суда, организует подготовку доказательств и ходатайств, обеспечивает грамотное обжалование решений и действий должностных лиц. Фокус — точная квалификация, соблюдение процессуальных сроков и минимизация правовых рисков для доверителя.",
    competencies: [
  ...
  },
  {
    ...
    shortBio:
      "Общий юридический стаж более 15 лет.\nПоложительный опыт в судах города Ростова-на-Дону и Ростовской области, города Москвы и Московской области.",
    statusText: "С 2017 года по настоящее время — адвокат.",
    ...
    education: [
      "2011 — Южный федеральный университет.",
