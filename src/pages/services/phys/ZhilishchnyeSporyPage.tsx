  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <meta
          name="description"
          content="Жилищные споры: защита прав на жильё, собственность и регистрацию. Москва и МО. Оценим перспективы и предложим понятный план действий."
        />
        ...
        >
          ...
          <div className="container relative z-10">
            ...
            <div className="max-w-4xl mt-6 space-y-5">
              <h1 className="font-serif text-h1-mobile md:text-h1 font-bold">Жилищные споры</h1>
              ...
              <p className="lead text-white/90">
                Помогаем защитить права на жильё, собственность и регистрацию. Оценим перспективы и предложим понятный
                план действий.
              </p>
              <Button
                size="lg"
