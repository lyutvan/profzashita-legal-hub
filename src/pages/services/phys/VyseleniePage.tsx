...
const VyseleniePage = () => {
  ...
  const cases = [
    {
      title: "Спор о праве пользования квартирой и порядке проживания",
      situation: "Собственник и бывший родственник не могли договориться о порядке пользования и доступе к квартире.",
      task: "Закрепить законный порядок пользования, защитить права собственника и исключить самовольные действия второй стороны.",
      actions: "Проанализировали документы, подготовили правовую позицию и доказательства, направили требования и представили интересы в суде.",
      result: "Суд определил порядок пользования, зафиксировал права сторон и снизил риск дальнейших конфликтов."
    },
    {
      title: "Залив квартиры и взыскание ущерба с управляющей компании",
      situation: "После повторного залива УК отказывалась признавать вину и компенсировать ущерб.",
      task: "Зафиксировать ответственность, взыскать ущерб и расходы на восстановление жилья.",
      actions: "Собрали акты, переписку и экспертизу, подготовили претензию и иск, сопровождали дело в суде и на стадии исполнения.",
      result: "Ущерб и расходы взысканы, обязанности УК зафиксированы документально."
    }
  ];
