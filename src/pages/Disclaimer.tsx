          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="border-border">
              <CardContent className="pt-8 space-y-6">
                ...
                <section>
                  <h2 className="font-serif text-h2-mobile md:text-h2 font-semibold mb-4">2. Точность информации</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section>
                  <h2 className="font-serif text-h2-mobile md:text-h2 font-semibold mb-4">3. Результаты прошлых дел</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section>
                  <h2 className="font-serif text-h2-mobile md:text-h2 font-semibold mb-4">4. Ссылки на сторонние ресурсы</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section>
                  <h2 className="font-serif text-h2-mobile md:text-h2 font-semibold mb-4">5. Ограничение ответственности</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section>
                  <h2 className="font-serif text-h2-mobile md:text-h2 font-semibold mb-4">6. Юрисдикция</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section>
                  <h2 className="font-serif text-h2-mobile md:text-h2 font-semibold mb-4">7. Конфиденциальность</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section>
                  <h2 className="font-serif text-h2-mobile md:text-h2 font-semibold mb-4">8. Обновления и изменения</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    свяжитесь с нами по адресу: profzashchita@internet.ru или по телефонам: +7 (495) 004-01-96, +7 (916) 859-76-54.
                  </p>
                </section>
