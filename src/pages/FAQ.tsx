    ...
    questions: [
      {
        ...
        a: "Вы можете записаться на консультацию через форму на сайте, по телефону +7 (495) 004-01-96 или отправив заявку через раздел 'Контакты'. Мы свяжемся с вами в течение 15 минут."
      },
      {
