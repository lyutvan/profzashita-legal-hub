  ...
  return (
    <Card className="group relative h-[260px] overflow-hidden border-2 hover:border-[#C9A227]/30 hover:shadow-lg transition-all duration-300">
      ...
      <Link
        ...
        className="absolute inset-0 z-30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C9A227] focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      />

      <div className="relative z-20 flex h-full flex-col justify-between p-6">
        <div className="font-montserrat text-2xl font-bold text-white leading-snug [text-shadow:0_3px_14px_rgba(0,0,0,0.6)]">
          {title}
        </div>
        <div className="flex items-center justify-between">
          <span className="text-[#C9A227] font-medium group-hover:underline [text-shadow:0_2px_10px_rgba(0,0,0,0.55)]">
            Подробнее
          </span>
          <ArrowRight className="h-5 w-5 text-[#C9A227] drop-shadow-[0_2px_10px_rgba(0,0,0,0.45)] group-hover:translate-x-1 transition-transform" />
        </div>
      </div>
    </Card>
  );
