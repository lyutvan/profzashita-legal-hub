    ...
    <footer className="relative bg-primary text-white overflow-hidden section section--tight">
      <div className="container section__content">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-serif text-h3-mobile font-semibold mb-4">Навигация</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/faq" className="text-small text-white/80 hover:text-accent transition-colors">
                  Вопросы и ответы
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:+74950040196" className="flex items-start gap-2 text-small text-white/80 hover:text-accent transition-colors">
                  <Phone className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  +7 (495) 004-01-96
                </a>
              </li>
              <li>
                <a href="mailto:profzashchita@internet.ru" className="flex items-start gap-2 text-small text-white/80 hover:text-accent transition-colors">
          ...
          {/* Legal */}
          <div>
            <h3 className="font-serif text-h3-mobile font-semibold mb-4">Документы</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/privacy" className="text-small text-white/80 hover:text-accent transition-colors">
            ...
            <div className="mt-4 space-y-1">
              ...
              <p className="text-small text-white/60">ОГРН: 1257700439303</p>
            </div>
          </div>
        </div>
