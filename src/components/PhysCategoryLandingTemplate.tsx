...
const PhysCategoryLandingTemplate = ({ data }: PhysCategoryLandingTemplateProps) => {
  ...
  const priceNote =
    ...
    "Точная стоимость зависит от сложности ситуации, объема документов и выбранного формата сопровождения.";
        ...
        <div className="space-y-2 text-small text-muted-foreground leading-relaxed">
          {priceFrom && (
            <p className="font-semibold text-slate-900">
              Ориентир по стоимости сопровождения: от {formatPrice(priceFrom)} ₽.
            </p>
          )}
          <p>
            {priceNote} После первичной оценки фиксируем объем работ и условия сотрудничества в договоре.
          </p>
  ...
  const bankrotstvoFaqItems = useMemo(
    () => [
      {
  ...
  const trudovyeFaqItems = useMemo(
    () => [
      {
  ...
  const trudovyeFaqQuestions = useMemo(
    () => [
  ...
  const consumerFaqItems = useMemo(
    () => [
      {
          ...
          <div className="container">
            ...
            <div className="mx-auto max-w-3xl">
              <PriceBlock
                ...
                fallbackNote="Точную стоимость назовем после изучения документов и деталей вашей ситуации."
              />
            </div>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <ul className="space-y-2 text-small text-muted-foreground">
                    {data.priceFactors.slice(0, 5).map((item) => (
                      <li key={item} className="flex items-start gap-2">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <div className="space-y-4">
                    {data.priceFormats.slice(0, 3).map((format) => (
                      <div key={format.title}>
                        <div className="font-semibold text-slate-900">{format.title}</div>
