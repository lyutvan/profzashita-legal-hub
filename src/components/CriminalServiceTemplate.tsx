  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Offer 24/48 */}
        <section id="offer" className="py-12 md:py-16 bg-muted/30">
        ...
        {/* Included */}
        <section id="included" className="py-12 md:py-16 scroll-mt-24">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mb-8">
              <h2 className="font-montserrat text-2xl md:text-3xl font-bold mb-3">
                Что входит в помощь
        ...
        {/* Practice */}
        <section id="practice" className="py-12 md:py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mb-8">
              <h2 className="font-montserrat text-2xl md:text-3xl font-bold mb-3">
                Практика и кейсы
        ...
        {/* Price */}
        <section id="price" className="py-12 md:py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mb-8">
              <h2 className="font-montserrat text-2xl md:text-3xl font-bold mb-3">
                Стоимость
        ...
        {/* Why Us */}
        <section id="why-us" className="py-12 md:py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mb-8">
              <h2 className="font-montserrat text-2xl md:text-3xl font-bold mb-3">
                Почему выбирают нас
