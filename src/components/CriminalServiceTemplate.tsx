        ...
        <section id="price" className="section">
          <div className="container">
            <div className="section__header max-w-3xl">
              ...
              <p className="text-muted-foreground">
                Окончательная стоимость зависит от статьи, стадии дела, числа эпизодов и объема материалов.
              </p>
            </div>
            <PriceBlock
              showTitle={false}
              ...
              fallbackNote="Точную стоимость защиты определим после анализа материалов и срочности подключений."
